...
| T8 | Durability | Codeberg's storage soft caps (750 MiB git, 1.5 GiB LFS/packages) come within reach. Repo is **~22 MB** today, so this is decades away at the current rate |
